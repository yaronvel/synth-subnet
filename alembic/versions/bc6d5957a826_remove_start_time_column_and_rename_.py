...
def upgrade() -> None:
    ...
    op.alter_column('miner_rewards', 'validation_time', new_column_name='start_time')
...
def downgrade() -> None:
    ...
    op.alter_column('miner_rewards', 'start_time', new_column_name='validation_time')
    op.add_column('miner_rewards', sa.Column('start_time', sa.TIMESTAMP(timezone=True), nullable=False))
